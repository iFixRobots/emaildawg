...
client, err := imap.NewClient(elp.email, elp.username, elp.password, nil, &logger, ConnectorInstance.Config.Logging.Sanitized, ConnectorInstance.Config.Logging.PseudonymSecret, ConnectorInstance.Config.IMAP.StartupBackfillSeconds, ConnectorInstance.Config.IMAP.StartupBackfillMax, ConnectorInstance.Config.IMAP.InitialIdleTimeoutSeconds)
	if err != nil {
